namespace Microsoft.Owin.Security.OpenIdConnect.Server {
    ...
    public class OpenIdConnectServerOptions : AuthenticationOptions
    {
        ...
        /// provider or format is assigned, a compatible instance must be assigned to the OpenID ConnectBearerAuthenticationOptions.AccessTokenProvider 
        /// or OpenID ConnectBearerAuthenticationOptions.AccessTokenFormat property of the resource server.
        /// </summary>
