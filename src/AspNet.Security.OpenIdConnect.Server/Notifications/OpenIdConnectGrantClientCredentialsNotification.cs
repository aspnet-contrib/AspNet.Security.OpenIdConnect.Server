...
namespace AspNet.Security.OpenIdConnect.Server {
    ...
    /// </summary>
    public sealed class OpenIdConnectGrantClientCredentialsNotification : BaseValidatingTicketContext<OpenIdConnectServerOptions> {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenIdConnectGrantClientCredentialsNotification"/> class
        /// </summary>
        /// <param name="context"></param>
        /// <param name="options"></param>
        /// <param name="tokenRequest"></param>
        internal OpenIdConnectGrantClientCredentialsNotification(
            HttpContext context,
