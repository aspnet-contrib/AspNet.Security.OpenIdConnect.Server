...
namespace AspNet.Security.OpenIdConnect.Server {
    /// <summary>
    /// Default implementation of <see cref="IOpenIdConnectServerEvents"/> used by the authorization
    /// server to communicate with the web application while processing requests.
    /// <see cref="OpenIdConnectServerEvents"/> provides some default behavior, 
    ...
    /// </summary>
    public class OpenIdConnectServerEvents : IOpenIdConnectServerEvents {
        /// <summary>
        ...
        /// The default behavior when using the OpenIdConnectServerEvents is to assume well-formed requests, with 
        ...
        /// The default behavior when using the OpenIdConnectServerEvents is to flow information from the authorization code to the access token unmodified.
        ...
        /// which information flows from the refresh token to the access token. The default behavior when using the OpenIdConnectServerEvents
